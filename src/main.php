...
public $Blocks = [
  ...
  public function sendMainShop(Player $player){
    ...
    $ui = new SimpleForm("§l§dFutureCraft §fShop§r","       §fPurchase and Sell items Here!");
    ...
    foreach($this->item as $category){
      ...
      if(isset($category["ICON"])){
        ...
        $button->addImage('url', "http://novask.in/4711174021054464".$rawitemdata[1]."-".$rawitemdata[2].".png");
